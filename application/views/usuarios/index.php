	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<a title="Cadastrar novo usuário" href="<?php echo base_url('usuarios/add'); ?>" class="btn btn-success btn-sm float-lg-right">
						...
						<tbody>
							<?php foreach ($usuarios as $user) : ?>
								<tr>
									...
									<td>
										<?php echo($this->ion_auth->is_admin($user->id)
											? 'Administrador'
											: 'Vendedor');
										?>
									</td>
									...
									<td class="text-center">
										...
										<a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#user-<?php echo $user->id; ?>" class="btn btn-sm btn-danger">
											<i class="fas fa-user-times"></i>&nbsp; Excluir
										</a>
									</td>
								</tr>

								<!-- Modal da exclusão de usuário -->
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a class="btn btn-danger btn-sm" href="<?php echo base_url('usuarios/delete/' .$user->id); ?>">Confirmar</a>
											</div>
										</div>
									</div>
								</div>
